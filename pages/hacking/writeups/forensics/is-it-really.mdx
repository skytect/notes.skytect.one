...
This challenge comes with a `signup.pdf` file which triggers most antiviruses.
Maybe there's some fragment inside the file thats causing the antivirus to act
up? Let's try running `binwalk`.
