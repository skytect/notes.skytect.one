...
Since he has a Twitter account, let's try doing
[a simple Twitter search](https://twitter.com/search?q=lewis%20chan&src=typed_query&f=user).
If we scroll down a little, we're able to find a very sus profile.

![twitter search](/images/whitehacks-2022/beginning-of-a-journey-1.png)

In the [profile](https://twitter.com/lewischan0601), there's a very sus pinned
tweet.

> Remember, when posting an image, make sure you have alt tags for
> accessibility.
